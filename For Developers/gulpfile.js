...
gulp.task('css-plugins', function() {
	...
	.pipe(concatCss('ptf-plugins.css'))
	.pipe(gulp.dest(cssFolder))
	.pipe(cleanCSS())
	.pipe(rename({
		suffix: '.min',
...
gulp.task('scripts', function() {
	...
	.pipe(concat('ptf-controllers.js'))
...
gulp.task('vendors', function() {
	return gulp.src([
		...
		vendorsFolder + 'jarallax.min.js',
		vendorsFolder + 'jarallax-video.min.js',
		vendorsFolder + 'css-vars-ponyfill.min.js'
	])
	.pipe(concat('ptf-plugins.js'))
	.pipe(gulp.dest(scriptsFolder))
	.pipe(uglify())
	.pipe(rename({
		suffix: '.min',
